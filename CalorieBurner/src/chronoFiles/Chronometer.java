...
public class Chronometer extends LinearLayout {
    ...
    private boolean isPlayPauseAlphaAnimation = false; 
    @SuppressWarnings("static-access")
	private String state = this.getStop();
	...
	public static Typeface getTypeface_Fabada (Context context) {
		return FontUtils.getTypeface(context, FontUtils.Fabada);
	}
	...
	private void playPauseAnimation (boolean flag) {
		if (flag == true) {
			new AnimationChronometre().getPauseAlpha(hoursTV);
			new AnimationChronometre().getPauseAlpha(minutesTV);
			new AnimationChronometre().getPauseAlpha(secondsTV);
		}
	}
